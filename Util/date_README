...
> (Korean Description) 원하는 날짜("2010-01-01")이 해당하는 년도의 몇 주차인지 계산하여 출력한다. 
...
> (Korean Description) 원하는 날짜("2010-01-01")의 포맷을 특정 포맷형식으로 변환하여 출력한다. 
...
> (Korean Description) 원하는 날짜("2010-01-01")의 해당하는 월을 출력한다. 
> (Engular Description) Print the corresponding month of the desired date ("2010-01-01"). 
> Return data = "2010/01" 


yearsCalc("2010-01-01");
> (Korean Description) 원하는 날짜("2010-01-01")부터 현재 날짜("2017-11-13")까지 해당하는 모든 년도를 출력한다. 
...
> (Korean Description) 원하는 날짜("2010-01-01")부터 현재 날짜("2017-11-13")까지 해당하는 모든 월을 출력한다. 
...
> (Korean Description) 원하는 날짜("2010-01-01")부터 현재 날짜("2017-11-13")까지 해당하는 모든 주를 출력한다. 
